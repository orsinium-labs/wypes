...
func TestResultOKUInt32(t *testing.T) {
	...
	stack := wypes.NewSliceStack(4)
	store := wypes.Store{Stack: stack, Memory: wypes.NewSliceMemory(1024)}
	result := wypes.Result[wypes.UInt32, wypes.UInt32, wypes.UInt32]{
		IsError: false,
		OK:      1,
		Offset:  64,
		DataPtr: 128,
...
func TestResultOKStringUInt32(t *testing.T) {
	...
	stack := wypes.NewSliceStack(4)
	store := wypes.Store{Stack: stack, Memory: wypes.NewSliceMemory(1024)}
	result := wypes.Result[wypes.String, wypes.String, wypes.UInt32]{
		IsError: false,
...
func TestResultOKListUInt32(t *testing.T) {
	...
	stack := wypes.NewSliceStack(4)
	store := wypes.Store{Stack: stack, Memory: wypes.NewSliceMemory(1024)}
	result := wypes.Result[wypes.List[wypes.UInt32], wypes.List[wypes.UInt32], wypes.UInt32]{
		IsError: false,
...
func TestResultErrListUInt32(t *testing.T) {
	...
	stack := wypes.NewSliceStack(4)
	store := wypes.Store{Stack: stack, Memory: wypes.NewSliceMemory(1024)}
	result := wypes.Result[wypes.List[wypes.UInt32], wypes.List[wypes.UInt32], wypes.String]{
		IsError: true,
...
func TestResultOKBytes(t *testing.T) {
	...
	stack := wypes.NewSliceStack(4)
	store := wypes.Store{Stack: stack, Memory: wypes.NewSliceMemory(1024)}
	result := wypes.Result[wypes.Bytes, wypes.Bytes, wypes.UInt32]{
		IsError: false,
